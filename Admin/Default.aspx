...
<head runat="server">
    <title>Holazeli Travels Admin</title>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="text-center mt-2">
                                                <a href="javascript:void();" class="d-inline-block auth-logo">
                                                    <img src="assets/images/logo.png" class="bg-dark" alt="" height="70" />
                                                </a>
                                            </div>
                                            <div class="text-center mt-2">
                                                <h5 class="text-primary">Welcome Back !</h5>
                                                <p class="text-muted">Sign in to continue to Holazeli Travels Admin</p>
