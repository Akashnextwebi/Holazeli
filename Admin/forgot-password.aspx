...
<head runat="server">
    <title>Holazeli Travels Password Recovery</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Holazeli Travels" name="author" />
    <!-- App fab -->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="text-center mt-2">
                                                <a href="/admin" class="d-inline-block auth-logo ">
                                                    <img src="assets/images/logo.png" class="bg-dark" height="70" />
                                                </a>
                                            </div>
                                            <div class="text-center mt-2">
                                                <h5 class="text-primary">Forgot Password?</h5>
                                                <p class="text-muted">Reset password with Holazeli Travels Admin</p>
                                            </div>
