...
public class UserRoles
{
    ...
    public static List<UserRoles> GetAllUserRoles(SqlConnection conHT)
    {
    ...
    public static int InsertUserRoles(SqlConnection conHT, UserRoles cat)
    {
        int result = 0;
    ...
    public static int UpdateUserRoles(SqlConnection conHT, UserRoles cat)
    {
        int result = 0;
    ...
    public static int DeleteUserRoles(SqlConnection conHT, UserRoles cat)
    {
        int result = 0;
    ...
    public static List<UserRolesAccess> GetAllUserRoles(SqlConnection conHT, string roleId)
    {
    ...
    public static List<UserRolesAccess> GetAllUserRolesCheck(SqlConnection conHT, string roleId, string pid)
    {
        List<UserRolesAccess> categories = new List<UserRolesAccess>();
        try
        {
    ...
    public static int InsertToRoleAccess(SqlConnection conHT, UserRolesAccess cat)
    {
        int result = 0;
    ...
    public static int UpdateRoleAccess(SqlConnection conHT, UserRolesAccess cat)
    {
        int result = 0;
