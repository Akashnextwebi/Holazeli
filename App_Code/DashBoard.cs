...
public class DashBoard
{
    ...
    /// </summary>
    /// <param name="conHT">DB connection</param>
    /// <returns>All list</returns>


    public static decimal GetTotalSales(SqlConnection conHT)
    {
        decimal x = 0;
        try
        {
    ...
    public static int GetOrderCount(SqlConnection conHT)
    {
        int x = 0;
        try
        {
    ...
    public static int GetCustomerCount(SqlConnection conHT)
    {
        int x = 0;
        try
        {
    ...
    public static int GetCustomerCountbyAguid(SqlConnection conHT)
    {
        int x = 0;
        try
        {
    ...
    public static int GetArchitectCount(SqlConnection conHT)
    {
        int x = 0;
        try
        {
    ...
    public static decimal NoOfContacts(SqlConnection conHT)
    {
        decimal x = 0;
        try
        {
    ...
    public static decimal TodaysOrder(SqlConnection conHT, string tDay)
    {
        decimal x = 0;
        try
        {
    ...
    public static decimal MonthsOrder(SqlConnection conHT, string mnth, string yr)
    {
        decimal x = 0;
        try
        {
