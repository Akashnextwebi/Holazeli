...
public class PageGroup
{
    ...
    public static List<PageGroup> GetAllPageGroup(SqlConnection conHT)
    {
    ...
    public static int InsertPageGroup(SqlConnection conHT, PageGroup cat)
    {
        int result = 0;
    ...
    public static int UpdatePageGroup(SqlConnection conHT, PageGroup cat)
    {
        int result = 0;
    ...
    public static int DeletePageGroup(SqlConnection conHT, PageGroup cat)
    {
        int result = 0;
