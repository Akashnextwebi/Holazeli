...
public class CreateUser
{
    ...
    public static List<CreateUser> GetAllUser(SqlConnection conHT)
    {
        ...
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand(query, conHT))
            {
    ...
    public static CreateUser GetUserDetails(SqlConnection conHT, string uGuid)
    {
    ...
    public static int InsertUser(SqlConnection conHT, CreateUser comp)
    {
        int result = 0;
    ...
    public static int UpdateUser(SqlConnection conHT, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UpdateUserByUser(SqlConnection conHT, CreateUser comp)
    {
        int result = 0;
        try
        {
    ...
    public static int UnBlockUser(SqlConnection conHT, string id, string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int BlockUser(SqlConnection conHT, string id,string addedBy)
    {
        int r = 0;
        try
        {
    ...
    public static int DeleteUser(SqlConnection conHT, CreateUser comp)
    {
        int result = 0;
    ...
    public static CreateUser Login(SqlConnection conHT, CreateUser loginInputs)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = new SqlCommand(query, conHT);
    ...
    public static CreateUser Login2(SqlConnection conHT, CreateUser loginInputs)
    {
        CreateUser login = new CreateUser();
        try
        {
    ...
    public static string ResetPassword(SqlConnection conHT, string email)
    {
        string login = "";
        try
        {
    ...
    public static string CheckPassKey(SqlConnection conHT, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string CheckResetLink(SqlConnection conHT, string uid)
    {
        string login = "";
        try
        {
    ...
    public static string GetLoggedUserName(SqlConnection conHT, string uid)
    {
        string login = "";
        try
        {
    ...
    public static void UpdateLastLoginTime(SqlConnection conHT, string uid)
    {
        try
        {
    ...
    public static string GetLoggedUserId(SqlConnection conHT, string uid)
    {
        string login = "";
        try
        {
    ...
    public static bool CheckIfAdmin(SqlConnection conHT, string uid)
    {
        bool login = false;
        try
        {
    ...
    public static int SetRestId(SqlConnection conHT, string uid, string resetId)
    {
        int r = 0;
        try
        {
    ...
    public static int SetResetTiming(SqlConnection conHT, string resetId, string pwd)
    {
        int x = 0;
        try
        {
    ...
    public static string ChangePassword(SqlConnection conHT, string aId, string nPwd)
    {
        string change = "";
        try
        {
    ...
    public static List<UserAccess> GetAllUserAccess(SqlConnection conHT, string uid)
    {
    ...
    public static List<UserAccess> LinkIfAdmin(SqlConnection conHT)
    {
        List<UserAccess> categories = new List<UserAccess>();
        try
        {
    ...
    public static bool CheckAccess(SqlConnection conHT, string pageL, string accessType, string uid)
    {
        bool x = false;
        if (CheckIfAdmin(conHT, uid))
        {
            x = true;
        }
        else
        {
            ...
            {
                case "add":
                    List<UserAccess> ua = GetAllUserAccess(conHT, uid).Where(s => s.PageLink == pageName && s.AddAccess == "1").ToList();
                    if (ua.Count > 0)
                        x = true;
                    break;
                case "edit":
                    List<UserAccess> ue = GetAllUserAccess(conHT, uid).Where(s => s.PageLink == pageName && s.EditAccess == "1").ToList();
                    if (ue.Count > 0)
                        x = true;
                    break;
                case "delete":
                    List<UserAccess> ud = GetAllUserAccess(conHT, uid).Where(s => s.PageLink == pageName && s.DeleteAccess == "1").ToList();
                    if (ud.Count > 0)
                        x = true;
                    break;
                case "view":
                    List<UserAccess> uv = GetAllUserAccess(conHT, uid).Where(s => s.PageLink == pageName && s.ViewAccess == "1").ToList();
                    if (uv.Count > 0)
                        x = true;
                    break;
            }
