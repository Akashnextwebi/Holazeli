...
public class PageMaster
{
    ...
    public static List<PageMaster> GetAllPageMaster(SqlConnection conHT)
    {
    ...
    public static int InsertPageMaster(SqlConnection conHT, PageMaster cat)
    {
        int result = 0;
    ...
    public static int UpdatePageMaster(SqlConnection conHT, PageMaster cat)
    {
        int result = 0;
    ...
    public static int DeletePageMaster(SqlConnection conHT, PageMaster cat)
    {
        int result = 0;
